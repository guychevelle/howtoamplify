...
*/
  ...
  /*  below not used since the Amplify Studio GalleryProfileCard
      configuration includes binding email; username is just not
      available to bind
  const profileemailOverrides = {
    "TextField": {
      value: props.userInfo.attributes.email
    }
  }
  */
